...
class MaximumCompositeDiscountTest {
    MaximumCompositeDiscount subject;
    @Mock
    ...
    void setup(){
        ...
        subject = new MaximumCompositeDiscount(LocalDate.MAX);
        subject.addDiscount(mockDiscount1);
        subject.addDiscount(mockDiscount2);
    }
    @Test
    void getPercent() {
        assertEquals(percent2, subject.getPercent(basketMock));
    }
